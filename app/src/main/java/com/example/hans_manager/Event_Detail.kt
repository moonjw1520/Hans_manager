...
import com.example.hans_manager.CRefreshDatabase.DeleteEventInDeliveryMan
import com.example.hans_manager.CRefreshDatabase.DeleteEventInEvent
import com.example.hans_manager.CRefreshDatabase.SynEventInDeliveryMan
import com.example.hans_manager.CRefreshDatabase.getNow
import com.example.hans_manager.CRefreshDatabase.synEventJustNum
...
class Event_Detail : AppCompatActivity() {
    ...
    fun ShowDlgSendSms(v: View) {
        ...
        builder.setIcon(R.drawable.hans_logo_h)
    ...
    fun setTextView() {
        ...
        m_strid = intent.getStringExtra("id")
        ...
        //사진 띄워주기
        SetFile(intent.getStringExtra("file1"))
    }
...
//    {
//        celearTextView()
//        txt_total_delivery.text = "총: ${CListCollector.list_event[m_nIndex_event].List_delivery_man.size}명"
//
//        if(CListCollector.list_event[m_nIndex_event].List_delivery_man.isEmpty()){
//            Log.d("로그", "list_delivery_man is empty")
//            return
//        }
//        for(inx in 0 until  CListCollector.list_event[m_nIndex_event].List_delivery_man.size)
//        {
//                if(inx>=m_list_txt_delivery_man.size) { return }
//            m_list_txt_delivery_man[inx].text = CListCollector.list_event[m_nIndex_event].List_delivery_man[inx].name
//
//        }
//    }
    ...
    fun SetFile(a_file_path: String) {
        ...
        if (a_file_path != null && a_file_path != "" && a_file_path != "null") {
            ...
            Glide
                ...
                .load(url)
                .centerCrop()
                .placeholder(R.drawable.hans_logo_h)
                .into(imageView1);
        } else {
...
//-------------------------------------이벤트 관련수정 2020-12-17-------------------------------------
    ...
    if(permissonCheck == PackageManager.PERMISSION_GRANTED){
        ...
        if(ActivityCompat.shouldShowRequestPermissionRationale(this, android.Manifest.permission.SEND_SMS)){
            ...
            ActivityCompat.requestPermissions(this@Event_Detail, arrayOf(android.Manifest.permission.SEND_SMS), RECORD_REQUEST_CODE);
        }else{
...
//        SMSSend.sendMultipartTextMessage(senddate, null, partMessage, null, null)
    ...
    {
        var SendMsg : String
        SendMsg = "[${a_name}님 HansFamily 배차 안내]\n"
...
//            if( list_event[i].event_time > list_event[m_nIndex_event].event_time)
//            {
//                Log.d("로그","현재 이벤트보다 시간이 더크다 이벤트 num: ${list_event[i].num} ${list_event[i].event_time}, 현재 이벤트: ${list_event[m_nIndex_event].event_time}")
//            }
        }
        if(lastFlag == 0)
        {
