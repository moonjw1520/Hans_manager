...
//class RecyclerStateAdapter(val modelist:ArrayList<String>, var m_StateRecyclerviewInterface : StateRecyclerviewInterface) :
                                                                            ...
                                                                            RecyclerView.Adapter<BranchStateViewHolder>()
{
    ...
    override fun onBindViewHolder(holder: BranchStateViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            (context as MainEventActivity).StateEventClicked(position, this.m_modelList[position])
