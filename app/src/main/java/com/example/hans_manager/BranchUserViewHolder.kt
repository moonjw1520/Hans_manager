...
import kotlinx.android.synthetic.main.layout_event_detail.view.*
import kotlinx.android.synthetic.main.recycler_item_user.view.*

class BranchUserViewHolder(itemView : View, a_MyRecyclerviewInterface : MyRecyclerviewInterface ) :
...
//        }
    ...
    override fun onClick(v: View?) {
        ...
        this.m_MyRecyclerviewInterface?.onItemClicked(adapterPosition, m_eventData)
    }
}
