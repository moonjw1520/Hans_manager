...
import com.example.hans_manager.CListCollector.NOW_DATE
import com.example.hans_manager.CListCollector.list_Matching
import com.example.hans_manager.CListCollector.list_MatchingMenu
...
import com.example.hans_manager.CRefreshDatabase.getNow
...
import kotlinx.android.synthetic.main.activity_main_event.recyclerview_main
import kotlinx.android.synthetic.main.layout_event_detail.*
...
class MainEventActivity : AppCompatActivity(), MyRecyclerviewInterface, StateRecyclerviewInterface
{
    val TAG : String = "로그"
    //var arraList_items: ArrayList<CEvent> = ArrayList()

//    var m_listText: ArrayList<CTextViewEventMain> = ArrayList()
    ...
    lateinit  var m_RecyclerAdt: RecyclerAdapter
    ...
    override fun onOptionsItemSelected(item: MenuItem?): Boolean {
        ...
        when(item!!.itemId){
            ...
            R.id.menu_create_event->{ // 새로운 이벤트 만들기
                ...
                var intent = Intent(this,ActivityCreateHansEvent::class.java)
...
//      var myDialog = EventDetailDialog(this)
//      myDialog.show()
    ...
    fun StateEventClicked(position: Int, aEventData: String)
    {
        ...
        val intent = Intent(this, EventDetailDay::class.java)
    ...
    override fun onRestart() {
        ...
        recyclerview_main.apply {
            //리사이클러뷰 설정
            layoutManager = LinearLayoutManager(this@MainEventActivity, LinearLayoutManager.HORIZONTAL, false)
           // LinearLayoutManager(this@MainEventActivity, LinearLayoutManager.HORIZONTAL, false)
            //어답터 장착
            adapter = m_RecyclerAdt
        ...
        setStatEventList()
        var RecyclerStateEventAdt = RecyclerStateAdapter(this, m_listStatEventDate, this@MainEventActivity)
        recyclerview_state_event.apply {
            //리사이클러뷰 설정
            layoutManager = LinearLayoutManager(this@MainEventActivity, LinearLayoutManager.HORIZONTAL, false)
            //어답터 장착
            adapter = RecyclerStateEventAdt
        ...
        client.newCall(request).enqueue(object : Callback {
            ...
            override fun onResponse(call: Call, response: Response) {
                ...
                runOnUiThread {
                    ...
                    m_RecyclerAdt= RecyclerAdapter(list_event, this@MainEventActivity)
                    recyclerview_main.apply {
                        //리사이클러뷰 설정
                        layoutManager = LinearLayoutManager(this@MainEventActivity, LinearLayoutManager.HORIZONTAL, false)
                        //어답터 장착
                    ...
                    setStatEventList()
                    m_RecyclerStateEventAdt = RecyclerStateAdapter(this@MainEventActivity, m_listStatEventDate, this@MainEventActivity)
                    recyclerview_state_event.apply {
                        //리사이클러뷰 설정
                        layoutManager = LinearLayoutManager(this@MainEventActivity, LinearLayoutManager.HORIZONTAL, false)
                        //어답터 장착
...
//        {
//            for(inx in 0 until  list_Matching)
//            {
...
//    }
    ...
    fun showListDeliveryPerson1(v: View)
    {
//        val nextIntent = Intent(this, ListDeliveryPersonActivity::class.java)
//        startActivity(nextIntent)

//        var myDialog = CListDialogDelivery(this)
//        myDialog = CListDialogDelivery(this)
//        myDialog.show()
...
//                CDeliveryPerson("010-2323-4442","김구라","2020-12-11"),
//                CDeliveryPerson("010-2321-4211","빅뱅","2020-12-11"),
//                CDeliveryPerson("010-2999-4572","용이","2020-12-11"),
//                CDeliveryPerson("010-2323-4442","김구라1","2020-12-11"),
//                CDeliveryPerson("010-2321-4211","빅뱅1","2020-12-11"),
//                CDeliveryPerson("010-2999-4572","용이1","2020-12-11"),
//                CDeliveryPerson("010-2323-4442","김구라2","2020-12-11"),
//                CDeliveryPerson("010-2321-4211","빅뱅2","2020-12-11"),
//                CDeliveryPerson("010-2999-4572","용이2","2020-12-11"),
//                CDeliveryPerson("010-2323-4442","김구라","2020-12-11"),
//                CDeliveryPerson("010-2321-4211","빅뱅","2020-12-11"),
//                CDeliveryPerson("010-2999-4572","용이","2020-12-11"),
//                CDeliveryPerson("010-2323-4442","김구라1","2020-12-11"),
...
//        builder.setAdapter(CustomListAdapter(this, DataList), null)
//
//        builder.show()
////
...
//        params?.width= (deviceWidth * 0.5).toInt()
        ...
        //builder.window().setAttributes(params);

        //builder?.window?.attributes = params as WindowManager.LayoutParams


        var data1 = arrayOf("항목1","항목2","항목3","항목4","항목5","항목6","항목7")
