...
import com.example.hans_manager.CPushHttp.SendPushInsert
...
class ActivityCreateHansEvent : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_create_hans_event)
